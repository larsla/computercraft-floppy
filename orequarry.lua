...
-- **    7th Dec 2015: [v0.72] Reports loot over rednet to node named "master"     ** --
-- **                                                                              ** --
-- ********************************************************************************** --
...
local masterId = rednet.lookup("master")
  ...
  if ((turtle.getItemCount(lastEmptySlot) > 0) or (returnBackToMiningPoint == false)) then
    ...
    while (slotLoop < 16) do
      ...
      if ((slotLoop <= noiseBlocksCount) or ((slotLoop == 15) and (lastEmptySlot == 14))) then
        ...
        if (turtle.getItemCount(slotLoop) > 0) then
          rednet.send(masterId, turtle.getItemDetail(slotLoop) .. ": " .. turtle.getItemCount(slotLoop), "reporting")
          turtle.drop()
        end
      end
